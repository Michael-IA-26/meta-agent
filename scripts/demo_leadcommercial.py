...
REPORT_PATH = Path(__file__).parent.parent / "docs" / "demo" / "rapport_demo_leadcommercial.html"
...
def send_telegram(leads: list[dict], dry_run: bool = False) -> bool:
    ...
    for lead in qualified[:5]:
        lines.append(f"• *{lead.get('denomination','?')}* ({lead.get('dept','')}) — score *{lead['score']}*")
    if len(qualified) > 5:
...
MOCK_COMPANIES = [
    {"siren": "900000001", "siret": "90000000100011", "denomination": "LE ZINC PARISIEN SAS", "forme_juridique": "5710", "code_naf": "56.10A", "dept": "75", "commune": "PARIS 11", "date_creation": "2026-05-20"},
    {"siren": "900000002", "siret": "90000000200011", "denomination": "DIGITAL CONSEIL SASU", "forme_juridique": "5720", "code_naf": "70.22Z", "dept": "92", "commune": "BOULOGNE-BILLANCOURT", "date_creation": "2026-05-20"},
    {"siren": "900000003", "siret": "90000000300011", "denomination": "BATI PRO IDF EURL", "forme_juridique": "5499", "code_naf": "43.21A", "dept": "93", "commune": "SAINT-DENIS", "date_creation": "2026-05-19"},
    {"siren": "900000004", "siret": "90000000400011", "denomination": "RAMEN TOKYO PARIS", "forme_juridique": "5710", "code_naf": "56.10B", "dept": "75", "commune": "PARIS 9", "date_creation": "2026-05-20"},
    {"siren": "900000005", "siret": "90000000500011", "denomination": "WELLNESS YOGA 78", "forme_juridique": "5710", "code_naf": "93.13Z", "dept": "78", "commune": "VERSAILLES", "date_creation": "2026-05-18"},
    {"siren": "900000006", "siret": "90000000600011", "denomination": "TRAITEUR DU SUD SAS", "forme_juridique": "5710", "code_naf": "56.21Z", "dept": "91", "commune": "ÉVRY", "date_creation": "2026-05-20"},
    {"siren": "900000007", "siret": "90000000700011", "denomination": "IMMO INVEST 94 SASU", "forme_juridique": "5720", "code_naf": "68.20A", "dept": "94", "commune": "CRÉTEIL", "date_creation": "2026-05-19"},
    {"siren": "900000008", "siret": "90000000800011", "denomination": "CLEANTECH SOLUTIONS", "forme_juridique": "5710", "code_naf": "38.21Z", "dept": "95", "commune": "CERGY", "date_creation": "2026-05-17"},
    {"siren": "900000009", "siret": "90000000900011", "denomination": "MODE & STYLE PARIS", "forme_juridique": "1000", "code_naf": "47.71Z", "dept": "75", "commune": "PARIS 8", "date_creation": "2026-05-20"},
    {"siren": "900000010", "siret": "90000001000011", "denomination": "CAFÉ DES ARTISTES 77", "forme_juridique": "5710", "code_naf": "56.30Z", "dept": "77", "commune": "MEAUX", "date_creation": "2026-05-19"},
]
...
def main() -> None:
    ...
    parser.add_argument("--mock", action="store_true", help="Utilise des données de démo (sans API Sirene)")
    ...
    for company in companies:
        ...
        logger.info("  %s (%s) — score %d — %s", company.get("denomination", "?"), company.get("dept", ""), result["score"], status)
